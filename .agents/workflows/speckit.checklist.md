---
description: "Spec Kit step: generate a requirements-quality checklist for a chosen domain."
---
...
2. Open `.claude/commands/speckit.checklist.md`, read it completely, and follow it exactly. Ignore its YAML front
   matter. Treat any text the user wrote after `/speckit.checklist` as `$ARGUMENTS` (scope such as `US1` or
