---
description: "Spec Kit step: resolve open questions in the current spec with the user."
---
...
2. Open `.claude/commands/speckit.clarify.md`, read it completely, and follow it exactly. Ignore its YAML front
   matter. Treat any text the user wrote after `/speckit.clarify` as `$ARGUMENTS` (scope such as `US1` or
