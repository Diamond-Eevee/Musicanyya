---
description: "Spec Kit step: amend the project constitution (only when the user explicitly asks)."
---
...
2. Open `.claude/commands/speckit.constitution.md`, read it completely, and follow it exactly. Ignore its YAML front
   matter. Treat any text the user wrote after `/speckit.constitution` as `$ARGUMENTS` (scope such as `US1` or
