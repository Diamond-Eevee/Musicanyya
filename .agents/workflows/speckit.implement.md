---
description: "Spec Kit step: implement tasks.md test-first, with claims, ticks, log and commits."
---
...
2. Open `.claude/commands/speckit.implement.md`, read it completely, and follow it exactly. Ignore its YAML front
   matter. Treat any text the user wrote after `/speckit.implement` as `$ARGUMENTS` (scope such as `US1` or
