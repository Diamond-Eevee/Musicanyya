---
description: "Spec Kit step: produce plan, research, data model, contracts and quickstart for the current feature."
---
...
2. Open `.claude/commands/speckit.plan.md`, read it completely, and follow it exactly. Ignore its YAML front
   matter. Treat any text the user wrote after `/speckit.plan` as `$ARGUMENTS` (scope such as `US1` or
