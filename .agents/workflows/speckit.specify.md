---
description: "Spec Kit step: create a feature specification (WHAT and WHY) on a new feature branch."
---
...
2. Open `.claude/commands/speckit.specify.md`, read it completely, and follow it exactly. Ignore its YAML front
   matter. Treat any text the user wrote after `/speckit.specify` as `$ARGUMENTS` (scope such as `US1` or
