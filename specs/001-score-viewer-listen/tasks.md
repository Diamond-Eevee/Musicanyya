...
- [~] T098 [P] [US2] UI tests: transport controls + shortcuts (Space, Esc), tempo 25-200 step 5, volume, loading progress, follow button in `tests/ui/transport.test.ts` (claimed: gemini-3.1-pro 2026-09-19)
