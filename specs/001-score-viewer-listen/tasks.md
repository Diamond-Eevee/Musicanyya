...
- [~] T096 [P] [US2] Dropout detection tests (browser stats path when present, clock-drift heuristic otherwise, counters since play/total) in `tests/engine/audio/dropouts.test.ts` (claimed: gemini-3.1-pro 2026-09-19)
